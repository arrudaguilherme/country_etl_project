...
from country_etl_project.models import CountryModel
from country_etl_project.db import Base, engine, SessionLocal
...
def transform(data:dict) -> pd.DataFrame:
    ...
    columns = ["country_name","country_code","country_independence_status","country_currency",
